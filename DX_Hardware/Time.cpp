...
Time::Time(unsigned char samples, double smoothFactor)
{
...
double Time::SmoothDelta()
{
	return localStack.smoothDelta;
}
double Time::SamplesPerSecond()
{
...
void Time::Throttle(double targetHz)
{
